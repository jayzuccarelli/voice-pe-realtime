...
The legacy SCENARIOS assume the internal ref turn hygiene is DISABLED (start the
...
# ----------------------------------------------------------------------------
# Turn-hygiene scenarios (internal ref) — run with --hygiene against an ISOLATED
